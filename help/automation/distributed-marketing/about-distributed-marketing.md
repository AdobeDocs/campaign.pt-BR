...
Para criar uma entidade organizacional, clique no link **[!UICONTROL Administration > Access management > Organizational entities]** e clique no link **[!UICONTROL New]** ícone acima da lista de entidades.
