...
Antes de começar a construir um fluxo de trabalho, lembre-se de definir supervisores de fluxo de trabalho. Eles serão notificados por email em caso de erro. Para obter mais informações, consulte [Gerenciando erros](monitor-workflow-execution.md#managing-errors).

Verifique regularmente a guia **[!UICONTROL Monitoring]** para visualizar o status geral dos fluxos de trabalho ativos. Para obter mais informações, consulte [Supervisão de instância](monitor-workflow-execution.md#instance-supervision).
