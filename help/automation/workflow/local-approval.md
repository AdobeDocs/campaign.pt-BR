...
Para obter um exemplo da atividade **[!UICONTROL Local approval]** com um modelo de distribuição, consulte [Uso da atividade de aprovação local](local-approval-activity.md).
