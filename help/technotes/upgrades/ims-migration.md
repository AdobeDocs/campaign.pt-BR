...
Se essa conta técnica for usada para fazer chamadas de API para a instância do Centro de Mensagens, certifique-se de selecionar o perfil de produto Adobe create que termina com `messagecenter`.
