---
title: Sobre o MTA aprimorado no Adobe Campaign
...
# Sobre o MTA aprimorado {#sending-with-enhanced-mta}
...
Ele é implementado para todos os clientes do Campaign v8 para melhorar a escalabilidade, aumentar a taxa de transferência de delivery e ajudar a enviar mais emails mais rapidamente. Isso é feito com novas técnicas de delivery adaptáveis que alteram as configurações de envio de email em tempo real, com base no feedback dos Provedores de serviço da Internet.
