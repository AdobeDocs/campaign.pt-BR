...
+ Introdução {#new}
   ...
   + {hide-from-toc}[Pixels de rastreamento de email e Orientação da CNIL](start/cnil-pixel-tracking.md)
...
+ Perfis e públicos-alvo {#audience}
...
+ Gerenciamento de dados {#data}
   + Consultar o banco de dados {#query}
