...
:seta_upper_right: Todos os atributos de formulário são listados na documentação do [Campaign Classic v7](https://docs.adobe.com/content/help/en/campaign-classic/technicalresources/api/control-Button.html).
