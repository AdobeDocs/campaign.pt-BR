...
As versões compatíveis com Android e iOS e as versões compatíveis com SDKs do Campaign para o Campaign v8 estão listadas na [Matriz de compatibilidade](../../rn/using/compatibility-matrix.md#MobileSDK) .
