...
* [Dynamic Reporting](https://experienceleague.adobe.com/docs/campaign-web/v8/reports/dynamic-reporting/get-started-reporting.html?lang=pt-BR){target="_blank"} (somente sob demanda)
* [Marcas centralizadas](https://experienceleague.adobe.com/docs/campaign-web/v8/conf/branding/branding-gs.html){target="_blank"} (somente sob demanda)
...
* O arquivo setup-client.exe foi substituído por um arquivo ac-client.msi. Isso oferece uma maneira mais fácil para os administradores executarem atualizações em massa sem a intervenção do usuário.
