...
Leia as práticas recomendadas com os recursos de delivery do Campaign.
...
Saiba mais sobre como iniciar uma nova plataforma no [Guia de práticas recomendadas de capacidade de entrega do Adobe](https://experienceleague.adobe.com/en/docs/deliverability-learn/deliverability-best-practice-guide/additional-resources/campaign/ac-starting-new-platform){target="_blank"}.
...
Trabalhe a [linha de assunto](../send/personalization-fields.md#personalization-fields-uc) para melhorar as taxas de abertura:
...
Saiba mais [nesta seção](../send/sms/smpp-external-account.md#smpp-transliteration).
...
A segmentação de público-alvo é fundamental: crie suas listas cuidadosamente, teste seus emails em clientes de email populares e dispositivos móveis e verifique se suas listas de email estão atualizadas (sem endereços desconhecidos ou obsoletos). Você também pode enviar provas que ajudam a configurar um ciclo de validação completo. Saiba mais sobre públicos-alvo [nesta seção](../audiences/gs-audiences.md).
