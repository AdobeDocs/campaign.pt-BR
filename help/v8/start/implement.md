...
![](../assets/do-not-localize/book.png) Saiba como adicionar usuários ao Adobe Campaign [nesta seção](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/permissions/access-management.html?lang=pt-BR#getting-started){target=&quot;_blank&quot;}.
...
1. Criar modelos
   ...
   ![](../assets/do-not-localize/book.png) Saiba como configurar um modelo de fluxo de trabalho na [documentação do Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/automating-with-workflows/introduction/building-a-workflow.html?lang=pt-BR#workflow-templates){target=&quot;_blank&quot;}
...
1. **Relatórios**
   ...
   ![](../assets/do-not-localize/glass.png) Saiba mais sobre os recursos de relatórios no Campaign [nesta página](reporting.md).
