...
Saiba como adicionar usuários ao Adobe Campaign no [nesta seção](../start/gs-permissions.md).

### Instalar console do cliente do Campaign{#implementation-install-console}
...
1. **Usar modelos**
   ...
   Saiba como configurar um modelo de fluxo de trabalho no [esta página](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=pt-BR){target="_blank"}.

   Saiba mais sobre modelos de email no [Documentação do Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/using-delivery-templates/about-templates.html?lang=pt-BR){target="_blank"}.
...
1. **Configurar regras de tipologia**
   ...
   Saiba mais sobre tipologias e gerenciamento de fadiga no [nesta seção](https://experienceleague.adobe.com/docs/campaign/automation/campaign-optimization/campaign-typologies.html?lang=pt-BR){target="_blank"}.
...
1. **Tabelas e esquemas**
   ...
   Consulte esta seção para saber mais sobre [Modelo de dados integrado do Campaign](../dev/datamodel.md).
...
1. **Painéis e listas**
   ...
   Saiba como gerenciar filtros e listas no Campaign no [esta página](../dev/customize.md#gs-lists-and-filters).
...
1. **Relatórios**
   ...
   Saiba mais sobre os recursos de relatórios no Campaign em [esta página](../reporting/gs-reporting.md).
...
Conheça a lista completa de soluções Adobe que podem ser integradas ao Adobe Campaign [nesta página](../connect/integration.md).
...
Saiba mais sobre conectores disponíveis em [nesta seção](../connect/integration.md).
...
Saiba como conectar seu sistema CRM ao Campaign no [nesta seção](../connect/integration.md#gs-crm-connectors)
...
Saiba como configurar o módulo FDA do Campaign para definir parâmetros de acesso no [nesta seção](../connect/integration.md#gs-fda)
